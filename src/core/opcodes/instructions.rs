...
impl Instruction
{
    ...
    fn from_byte_not_prefixed(byte: u8) -> Option<Instruction>
    {
        match byte
        {
            ...
            0x8B => Some(Instruction::SBC(ArithmeticTarget::E)),
            0x8C => Some(Instruction::SBC(ArithmeticTarget::H)),
            0x8D => Some(Instruction::SBC(ArithmeticTarget::L)),
            0x8E => Some(Instruction::SBC(ArithmeticTarget::HL)),
            0x8F => Some(Instruction::SBC(ArithmeticTarget::A)),
            => None
